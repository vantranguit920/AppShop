...
public class ThongtinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(10.870393, 106.803780);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Đại học Công Nghệ Thông Tin").snippet("Phường Linh Trung, Thủ Đức, Hồ Chí Minh, Việt Nam").icon(BitmapDescriptorFactory.defaultMarker()));
